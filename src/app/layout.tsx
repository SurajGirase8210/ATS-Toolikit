...
const CopilotChat = dynamic(
  () => import('@/components/layout/CopilotChat'),
  { ssr: false }
);
...
export const metadata: Metadata = {
  ...
  description:
    'Analyze job descriptions, check ATS resume match, find skill gaps, optimize resumes with evidence, prepare for interviews, and track applications.',
  ...
  openGraph: {
    ...
    description:
      'Match your resume to jobs, identify skill gaps, optimize safely, prepare for interviews, and track applications.',
    locale: 'en_US',
  },
